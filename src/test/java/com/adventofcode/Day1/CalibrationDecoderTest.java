...
public class CalibrationDecoderTest {
    ...
    @Test
    public void decodeWhenNoActionRequired(){
        assertEquals(Integer.valueOf(12), CalibrationDecoder.decode("12"));
    }

    @Test
    public void decodeWithLetterInBetween(){
        assertEquals(Integer.valueOf(12), CalibrationDecoder.decode("1a2"));
    }

    @Test
    public void decodeWithLetterBefore(){
        assertEquals(Integer.valueOf(12), CalibrationDecoder.decode("a12"));
    }

    @Test
    public void decodeWithLetterAfter(){
        assertEquals(Integer.valueOf(12), CalibrationDecoder.decode("12a"));
    }

    @Test
    public void decodeRandomCode(){
        assertEquals(Integer.valueOf(12), CalibrationDecoder.decode("aagag1ds3grzevz6gfentnt7h2fdshjaqjt"));
    }

    @Test
    public void decodeRandom2Code(){
        assertEquals(Integer.valueOf(79), CalibrationDecoder.decode("7559tfhcdvkthgx"));
    }
    
    @Test
    public void decodeListOfCodeAndReturnTheSum(){
        String[] list = {"a12", "12a"};
        assertEquals(Integer.valueOf(24), CalibrationDecoder.decodeManyAndSum(list));
    }


    @Test
    public void decodeWeirdListOfCodeAndReturnTheSum(){
        String[] list = {"a3", "1a"};
        assertEquals(Integer.valueOf(44), CalibrationDecoder.decodeManyAndSum(list));
    }
    
    @Test
    public void decodeAnotherListOfCodeAndReturnTheSum(){
        String[] list = {"a12", "12a", "njegpbzhjbvphiz34"};
        assertEquals(Integer.valueOf(58), CalibrationDecoder.decodeManyAndSum(list));
    }

    @Test
    public void decodeExampleListOfCodeAndReturnTheSum(){
        String[] list = {"1abc2",
            "pqr3stu8vwx",
            "a1b2c3d4e5f",
            "treb7uchet"};
        assertEquals(Integer.valueOf(142), CalibrationDecoder.decodeManyAndSum(list));
    }

    @Test
    public void decodeExampleListOfCodeAndReturnTheSumPart2(){
        String[] list = {"two1nine",
            ...
            "zoneight234",
            "7pqrstsixteen"};
        assertEquals(Integer.valueOf(281), CalibrationDecoder.decodeManyAndSum(list));
    }

    @Test
    public void decodeIndividuallyTheDocument(){
        String[] calibrationDocument = {"mxmkjvgsdzfhseightonetwoeight7",
        ...
        for (int i=0; i<calibrationDocument.length; i++ ){
            assertTrue(CalibrationDecoder.decode(calibrationDocument[i])>10);
        }
    }
    ...
    public void andTheResultIs(){
        ...
        "ktgfiveone76ghj",
        "7zgzsevenftkdfour186"};
        assertEquals(Integer.valueOf(53592), CalibrationDecoder.decodeManyAndSum(calibrationDocument));
    }
