...
public class GameTest {
  ...
  @Test
  public void get_game_from_document_string() {
    ...
    assertEquals(
      testGame.id,
      DocumentParser.getGameFromLine(documentString).id
    );
    assertEquals(
      testGame.handfullsOfCubes[0].get("red"),
      DocumentParser
        .getGameFromLine(documentString)
        .handfullsOfCubes[0].get("red")
    );
    assertEquals(
      testGame.handfullsOfCubes[0].get("green"),
      DocumentParser
        .getGameFromLine(documentString)
        .handfullsOfCubes[0].get("green")
    );
    assertEquals(
      testGame.handfullsOfCubes[0].get("blue"),
      DocumentParser
        .getGameFromLine(documentString)
        .handfullsOfCubes[0].get("blue")
    );
  }

  @Test
  public void get_sum_of_exemple_doc() {
    String[] docExample = {
      "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green",
    ...
    assertEquals(8, ProblemResolver.resolvePart1(docExample));
  }

  @Test
  public void get_sum_of_official_doc() {
    String[] docExample = {
    ...
    assertEquals(1931, ProblemResolver.resolvePart1(docExample));
  }

  @Test
  public void get_part2_solution_of_exemple_doc() {
    String[] docExample = {
      "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green",
      "Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue",
      "Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red",
    ...
    assertEquals(2286, ProblemResolver.resolvePart2(docExample));
  }

  @Test
  public void get_part2_solution_of_official_doc() {
    String[] docExample = {
      "Game 1: 1 red, 3 blue, 11 green; 1 blue, 5 red; 3 blue, 5 green, 13 red; 6 red, 1 blue, 4 green; 16 red, 12 green",
      "Game 2: 3 red, 13 blue, 5 green; 14 green, 14 blue; 9 blue, 10 green, 3 red; 2 green, 5 blue; 11 green, 3 blue, 3 red; 16 blue, 2 red, 9 green",
      "Game 3: 17 blue, 5 red; 3 red, 11 green, 17 blue; 1 red, 6 blue, 9 green; 3 blue, 11 green, 1 red; 3 green, 10 red, 11 blue; 12 red, 3 green, 15 blue",
    ...
    assertEquals(83105, ProblemResolver.resolvePart2(docExample));
  }
}
